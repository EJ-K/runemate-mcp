...
public final class BZip2Decompressor {
    ...
    private static final BZip2BlockEntry entry = new BZip2BlockEntry();
    ...
    private static void method1786(
        int[] ai, int[] ai1, int[] ai2, byte[] abyte0, int i, int j,
        int k
    ) {
        int l = 0;
    ...
    public static int decompress(
        byte[] destination, int decompressedSize, byte[] source,
        int offset
    ) {
        synchronized (entry) {
            entry.source = source;
    ...
    private static void processDecompression(BZip2BlockEntry entry) {
        entry.hundred_k_blocksize = 1;
        if (arr == null) {
            arr = new int[entry.hundred_k_blocksize * 100000];
        }
        boolean flag18 = true;
        int[] ai2 = null;
        int[] ai1 = null;
        ...
        while (flag18) {
            ...
            for (int l = 0; l < 16; l++) {
                if (entry.aBooleanArray2205[l]) {
                    for (int i3 = 0; i3 < 16; i3++) {
                        ...
                        if (byte2 == 1) {
                            entry.aBooleanArray2213[(l << 4) + i3] = true;
                        }
                    }
            ...
            for (int l3 = 0; l3 < j4; l3++) {
                ...
                method1786(entry.anIntArrayArray2230[l3], entry.anIntArrayArray2218[l3],
                    entry.anIntArrayArray2210[l3], entry.aByteArrayArray2229[l3], byte8, i, i4
                );
            ...
            for (int k8 = 15; k8 >= 0; k8--) {
                for (int l8 = 15; l8 >= 0; l8--) {
                    entry.aByteArray2204[i9] = (byte) ((k8 << 4) + l8);
                    i9--;
                }
            ...
            for (int k5 = ai2[k7 - ai1[l6]]; k5 != l4; ) {
                if (k5 == 0 || k5 == 1) {
                    ...
                    i6++;
                    byte byte5 =
                        entry.aByteArray2211[entry.aByteArray2204[entry.anIntArray2226[0]] & 0xff];
                    ...
                    if (i11 < 16) {
                        ...
                        for (; k10 > 0; k10--) {
                            ...
                            entry.aByteArray2204[entry.anIntArray2226[k10]] =
                                entry.aByteArray2204[(entry.anIntArray2226[k10 - 1] + 16) - 1];
                        }
                            ...
                            for (int j9 = 15; j9 >= 0; j9--) {
                                for (int k9 = 15; k9 >= 0; k9--) {
                                    entry.aByteArray2204[l9] =
                                        entry.aByteArray2204[entry.anIntArray2226[j9] + k9];
                                    l9--;
                                }
